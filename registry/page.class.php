...
/**
 Page object for template manager (/registry/template.class.php)
 This is where the contents of the templates and replacement data are stored
...
class page {
	...
	// page elements - the replacement data
	...
	/**
	 Get tags associated with the page to perform replacement
	 @return void
	 */
	...
	/**
	 Add a template bit to the page (doesn't actually add the content until later in the code)
	...
	/**
	 ...
	 A.P.D. is used in parsing loops.  We may want to have an extra bit of data depending on the iterations values
	...
	/**
	 ...
	 @return array the arry of template tags and template file names
	 */
	...
	/**
	 Return array of additional parsing data for template handler to process
	 */
	...
	/**
	 Gets a chunk (loop content) of page content
	...
	/**
	 Final replacements for things like registration forms
	 */
	public function getContentToPrint() {
		...
		$this->content = str_replace('</body>', '	<!-- Generated by IvyNexus -->	
    </body>', $this->content);
		return $this->content;
	}
