		...
		while($row = mysql_fetch_array($query)){
			...
			// if no name = anonymous
				...
				echo '<tr height="40px" class="threadlist" onclick="document.location='.$redirect.'" valign="top">
					...
					<td  style="border-bottom: 1px solid #fff;"><a href="ideas/view/'.$row["id"].'" class="threadlist">'.$row["idea_name"].'<br /><span style="color:#777;font-size:12px;">'.substr($row["description"], 0, 100).'</span></a></td>
