<?php
/*** This is the place command that allows user to place his new soldiers into one of his states ***/
	...
	$personaltroops = mysqli_real_escape_string($link,$_GET["a"]);
	$placingtroops = mysqli_real_escape_string($link,$_GET["b"]);
	$id = mysqli_real_escape_string($link,$_GET["d"]);
	$whereplacing = mysqli_real_escape_string($link,$_GET["e"]);
	$turn = mysqli_real_escape_string($link, $_GET["f"]);
