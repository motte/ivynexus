...
class Relationshipscontroller{
	 ...
	 * @param bool $directCall - we are either calling directly via the framework (true), or via another controller (false)
	 */
	...
	private function viewAll($user) {
		if($this->registry->getObject('authenticate')->isLoggedIn()) {
			...
			$this->registry->errorPage('Please login', 'Please login to view  users connections');
		}
	}
}
