...
;
			...
			echo '<div title="'.$info.'"><img onclick="loadevent('.$eventSetNumber.')" onmouseover="flipEvent('.$eventSetNumber.')" onmouseout="revert('.$eventSetNumber.')" class="sqrResize100" src="uploads/events/sqr'.$event_row['photo'].'" /></div>';
