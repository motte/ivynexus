...
<form action="profile/statuses/{profile_user_id}" method="post">
	...
	<button type="submit" id="postmessage" class="btn" value="Update">Update</button>
	<!--<input type="submit" onclick="loadXMLDoc()" id="postmessage" name="postmessage" value="Update" />-->
</form>
