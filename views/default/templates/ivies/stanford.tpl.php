...
<body id="stanford">
	...
	<div id="dart"></div>
	<center><h1 id="dartmouth"><div id="transbar">Stanford University</div></h1></center>
	
	<!--<p class="fifty">
        <center class="engraved2">| Stanford, California | Founded 1885 | Cardinal |</center>
	</p>-->
	...
	<td width="60%" valign="top" class="leftright">
		<div id="center">
			...
			<!-- This is where you adjust the textarea shout out area width:98%; -->
				<textarea id="postbox" name="postbox" class="input" placeholder=" Shout Out To Stanford!" wrap="hard"></textarea>
