...
b=b.replace(/\r\n|\r|\n/g, "<br />");
	...
	function initializePostbox() {
		...
		if(post == 'Shout Out To Princeton!' || ' Shout Out To Princeton' || '') {
...
<tr>
	<td width="30%"><span id="princetonuniversity"></span></td>
	...
	<td width="60%">
		...
		<div id="adjustpostbox">
			...
			<!-- This is where you adjust the textarea shout out area width:98%; -->
				<center><textarea id="postbox" name="postbox" class="input" placeholder=" Shout Out To Princeton!" wrap="hard" onfocus="focusPostbox()" onblur="initializePostbox()"></textarea></center>
