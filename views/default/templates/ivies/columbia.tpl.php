...
<body id="columbia">
	...
	<div id="dart"></div>
	<center><h1 id="dartmouth"><div id="transbar">Columbia University</div></h1></center>
	
	<!--<p class="fifty">
        <center class="engraved2">| New York, New York | Founded 1754 | Lions |</center>
	</p>-->
	...
	<td width="60%" valign="top" class="leftright">
		<div id="center">
			...
			<!-- This is where you adjust the textarea shout out area width:98%; -->
				<textarea id="postbox" name="postbox" class="input" placeholder=" Shout Out To Columbia!" wrap="hard"></textarea>
