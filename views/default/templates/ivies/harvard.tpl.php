...
<body id="harvard">
	...
	<div id="dart"></div>
	<center><h1 id="dartmouth"><div id="transbar">Harvard University</div></h1></center>
	
	<!--<p class="fifty">
        <center class="engraved2">| Cambridge, Massachusetts | Founded 1636 | John Harvard |</center>
	</p>-->
	...
	<td width="60%" valign="top" class="leftright">
		<div id="center">
			...
			<!-- This is where you adjust the textarea shout out area width:98%; -->
				<textarea id="postbox" name="postbox" class="input" placeholder=" Shout Out To Harvard!" wrap="hard"></textarea>
