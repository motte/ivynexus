...
<body id="mit">
	...
	<div id="dart"></div>
	<center><h1 id="dartmouth"><div id="transbar">Massachusetts Institute of Technology</div></h1></center>
	
	<!--<p class="fifty">
        <center class="engraved2">| Cambridge, Massachusetts | Founded 1861 | Tim the Beaver |</center>
	</p>-->
	...
	<td width="60%" valign="top" class="leftright">
		<div id="center">
			...
			<!-- This is where you adjust the textarea shout out area width:98%; -->
				<textarea id="postbox" name="postbox" class="input" placeholder=" Shout Out To MIT!" wrap="hard"></textarea>
				
				
				<input type="hidden" name="school" id="school" value="mit" />
