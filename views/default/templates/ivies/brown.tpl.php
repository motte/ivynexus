...
b=b.replace(/\r\n|\r|\n/g, "<br />");
	...
	function initializePostbox() {
		...
		if(post == 'Shout Out To Brown!' || ' Shout Out To Brown' || '') {
...
<tr>
	<td width="30%"><span id="brownuniversity"></span></td>
	...
	<td width="60%">
		...
		<div id="adjustpostbox">
			...
			<!-- This is where you adjust the textarea shout out area width:98%; -->
				<center><textarea id="postbox" name="postbox" class="input" placeholder=" Shout Out To Brown!" wrap="hard" onfocus="focusPostbox()" onblur="initializePostbox()"></textarea></center>
				
				
				<input type="hidden" name="school" id="school" value="brown" />
