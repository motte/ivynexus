...
b=b.replace(/\r\n|\r|\n/g, "<br />");
	...
	function initializePostbox() {
		...
		if(post == 'Shout Out To Cornell!' || ' Shout Out To Cornell' || '') {
...
<tr>
	<td width="30%"><span id="cornelluniversity"></span></td>
	...
	<td width="60%">
		...
		<div id="adjustpostbox">
			...
			<!-- This is where you adjust the textarea shout out area width:98%; -->
				<center><textarea id="postbox" name="postbox" class="input" placeholder=" Shout Out To Cornell!" wrap="hard" onfocus="focusPostbox()" onblur="initializePostbox()"></textarea></center>
				
				
				<input type="hidden" name="school" id="school" value="cornell" />
