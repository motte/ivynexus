...
<body id="dartmouth">
	...
	<div id="dart"></div>
	<center><h1 id="dartmouth"><div id="transbar">Dartmouth College</div></h1></center>
	
	<!--<p class="fifty">
        <center class="engraved2">| Hanover, New Hampshire | Founded 1769 | Big Green |</center>
	</p>-->
	...
	<td width="20%" valign="top" class="borderright">
		<center>
			<div style="background: #fff;" class="photoborder">
	                        <span id="pleft1">
				        <img id="pleft1" class="pleft" src="uploads/profile/sqr13560622606560_1024040459092_7922173_n.jpg"></img>
			        </span>
			...
			<div style="background: #fff;" class="photoborder">
	                        <span id="phleft2">
				        <img id="phleft2" class="pleft" src="uploads/photos/sqr1356565120crop380w_copy_of_party.jpg.jpg"></img>
			        </span>
	                        <div style='height:10px;'></div>
                        ...
                        <div style="background: #fff;" class="photoborder">
	                        <span id="eveleft3">
				        <img id="eveleft3" class="pleft" src="uploads/profile/sqrman.png" />
			        </span>
	                        <div style='height:10px;'></div>
...
$(function() {
	...
	<td width="20%" valign="top" class="borderleft">
		<center>
                        <div style="background: #fff;" class="photoborder">
			        <span id="pright1">
				        <img id="pright1" class="pright" src="uploads/profile/sqr{p_photo}" />
			        </span>
	                        <div style='height:10px;'></div>
                        ...
                        <div style="background: #fff;" class="photoborder">
	                        <span id="everight2">
				        <img id="everight2" class="pright" src="uploads/events/sqr1348031218376678_10151032813188321_1707717410_n.jpg.jpg" />
			        </span>
	                        <div style='height:10px;'></div>
                        ...
                        <div style="background: #fff;" class="photoborder">									
	                        <span id="phright3">
				        <img id="phright3" class="pright" src="uploads/photos/sqr1356565120crop380w_copy_of_party.jpg.jpg"></img>
			        </span>
	                        <div style='height:10px;'></div>
