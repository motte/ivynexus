...
<body id="penn">
	...
	<div id="dart"></div>
	<center><h1 id="dartmouth"><div id="transbar">University of Pennsylvania</div></h1></center>
	
	<!--<p class="fifty">
        <center class="engraved2">| Philadelphia, Pennsylvania | Founded 1740 | Quaker |</center>
	</p>-->
	...
	<td width="60%" valign="top" class="leftright">
		<div id="center">
			...
			<!-- This is where you adjust the textarea shout out area width:98%; -->
				<textarea id="postbox" name="postbox" class="input" placeholder=" Shout Out To UPenn!" wrap="hard"></textarea>
				
				
				<input type="hidden" name="school" id="school" value="penn" />
