...
class Relationship {
     ...
     * This forms (creates, updates, deletes relationships easily) relationships between users
     ...
     */
    public function createRelationship($usera, $userb, $approved=0, $type=1) {
        ...
        if($this->registry->getObject('db')->numRows() == 1) {
            ...
            if($type != 0) {
                ...
                if($this->registry->getObject('db')->numRows() == 1) {
                    ...
                    /* For some reason everything is being auto approved
                  	if($data['mutual'] == 0) {
                        $approved = 1;
                        break;
                    }*/
